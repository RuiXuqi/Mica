...
public interface DwmApi extends Library {
    ...
    enum DWM_SYSTEMBACKDROP_TYPE implements ModConfig.ITranslatable {
    ...
    enum DWM_WINDOW_CORNER_PREFERENCE implements ModConfig.ITranslatable {
    ...
    static void updateDwm(final boolean fullscreen, final long window) {
        ...
        final boolean useImmersiveDarkMode = ModConfig.useImmersiveDarkMode;
        ...
        if (Mica.buildNumber >= Mica.BACKDROP_BUILD_NUM) {
            final DWM_SYSTEMBACKDROP_TYPE systemBackdropType = ModConfig.systemBackdropType;
